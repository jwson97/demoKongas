...
def load_documents():
    ...
    for doc_file in doc_paths:
        ...
        try:
            ...
            st.error(f"Error loading document {doc_file}: {e}")
    return docs
...
def setup_rag():
    ...
    return vector_db, ensemble_retriever, multi_query_retriever, llm
...
vector_db, ensemble_retriever, multi_query_retriever, llm = setup_rag()
